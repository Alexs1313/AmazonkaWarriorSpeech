...
const AmznkaWrriorSpeechLoad = () => {
  const navigation = useNavigation();

  useEffect(() => {
    const welcomeLoaderTimer = setTimeout(() => {
      navigation.navigate('AmznkaWrriorSpeechOnb' as never);
    }, 6113);
    ...
    <View style={styles.backgroundImg}>
      <ScrollView
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
          <Image source={require('../../assets/i/amznkawrriorsload.png')} />
        </View>
...
export default AmznkaWrriorSpeechLoad;
