export type FluxLaneId = 'warrior' | 'jungle' | 'queen';

export type FluxCadence = 'slow' | 'medium' | 'fast';

export type FluxPassageScale = 'small' | 'medium' | 'large';

export type FluxPassage = {
  fluxPassageId: string;
  fluxPassageTitle: string;
  fluxPassageBody: string;
};

export type FluxLane = {
  fluxCategoryId: FluxLaneId;
  fluxCategoryEmoji: string;
  fluxCategoryTitle: string;
  fluxCategoryDescription: string;
  fluxCategoryIconBg: string;
  fluxCategoryIconBorder: string;
  fluxCategoryBadgeColor: string;
  fluxCategoryBadgeBg: string;
  fluxCategoryBadgeBorder: string;
  fluxCategoryTexts: FluxPassage[];
};

export const fluxCadencePx: Record<
  FluxCadence,
  number
> = {
  slow: 22,
...
export const fluxPassageScaleStyle: Record<
  FluxPassageScale,
...
export const fluxLanes: FluxLane[] =
  [
    {
      fluxCategoryId: 'warrior',
      fluxCategoryEmoji: '⚔️',
      fluxCategoryTitle: 'Warrior Speeches',
      fluxCategoryDescription:
        'Battle speeches for voice power & confident delivery',
      fluxCategoryIconBg: 'rgba(255, 107, 53, 0.13)',
      fluxCategoryIconBorder: 'rgba(255, 107, 53, 0.27)',
      fluxCategoryBadgeColor: '#FF6B35',
      fluxCategoryBadgeBg: 'rgba(255, 107, 53, 0.08)',
      fluxCategoryBadgeBorder: 'rgba(255, 107, 53, 0.27)',
      fluxCategoryTexts: [
        {
          fluxPassageId: 'warrior-1',
          fluxPassageTitle: 'The Voice Before Battle',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'warrior-2',
          fluxPassageTitle: 'Fire of the Jungle',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'warrior-3',
          fluxPassageTitle: 'Strength of the Shield',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'warrior-4',
          fluxPassageTitle: 'Storm Across the River',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'warrior-5',
          fluxPassageTitle: 'Words of the Golden Queen',
          fluxPassageBody:
    ...
    {
      fluxCategoryId: 'jungle',
      fluxCategoryEmoji: '🌿',
      fluxCategoryTitle: 'Jungle Stories',
      fluxCategoryDescription:
        'Legends for smooth reading & emotional expression',
      fluxCategoryIconBg: 'rgba(92, 184, 92, 0.13)',
      fluxCategoryIconBorder: 'rgba(92, 184, 92, 0.27)',
      fluxCategoryBadgeColor: '#5CB85C',
      fluxCategoryBadgeBg: 'rgba(92, 184, 92, 0.08)',
      fluxCategoryBadgeBorder: 'rgba(92, 184, 92, 0.27)',
      fluxCategoryTexts: [
        {
          fluxPassageId: 'jungle-1',
          fluxPassageTitle: 'The Hidden River Path',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'jungle-2',
          fluxPassageTitle: 'The Night of Whispering Trees',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'jungle-3',
          fluxPassageTitle: 'The Eagle Above the Jungle',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'jungle-4',
          fluxPassageTitle: 'The Temple Beyond the Trees',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'jungle-5',
          fluxPassageTitle: 'The Voice Near the Waterfall',
          fluxPassageBody:
    ...
    {
      fluxCategoryId: 'queen',
      fluxCategoryEmoji: '👑',
      fluxCategoryTitle: "Queen's Advice",
      fluxCategoryDescription:
        'Wisdom for calm, expressive & persuasive speech',
      fluxCategoryIconBg: 'rgba(255, 153, 0, 0.13)',
      fluxCategoryIconBorder: 'rgba(255, 153, 0, 0.27)',
      fluxCategoryBadgeColor: '#FF9900',
      fluxCategoryBadgeBg: 'rgba(255, 153, 0, 0.08)',
      fluxCategoryBadgeBorder: 'rgba(255, 153, 0, 0.27)',
      fluxCategoryTexts: [
        {
          fluxPassageId: 'queen-1',
          fluxPassageTitle: 'Speak Like a Leader',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'queen-2',
          fluxPassageTitle: 'The Power of Calm Words',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'queen-3',
          fluxPassageTitle: 'Confidence Grows Through Practice',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'queen-4',
          fluxPassageTitle: 'Listen Before You Speak',
          fluxPassageBody:
        ...
        {
          fluxPassageId: 'queen-5',
          fluxPassageTitle: 'The Strength Inside Your Voice',
          fluxPassageBody:
...
export const fluxPassageCount =
  fluxLanes.reduce(
    (fluxSum, fluxCategory) =>
      fluxSum +
      fluxCategory.fluxCategoryTexts.length,
    0,
  );

export const fluxGetCategory = (
  fluxCategoryId: FluxLaneId,
) =>
  fluxLanes.find(
    fluxCategory =>
...
export const fluxGetCategoryTexts = (
  fluxCategoryId: FluxLaneId,
  fluxExtraTexts: FluxPassage[] = [],
) => {
  const fluxCategory = fluxGetCategory(
    fluxCategoryId,
  );
  if (!fluxCategory) {
    return fluxExtraTexts;
  }
  return [
...
export const fluxGetText = (
  fluxCategoryId: FluxLaneId,
  fluxPassageId: string,
  fluxExtraTexts: FluxPassage[] = [],
) => {
  return fluxGetCategoryTexts(
    fluxCategoryId,
    fluxExtraTexts,
  ).find(
    fluxPassage =>
